...
class F0_Extractor:
    def __init__(self, f0_extractor, sample_rate = 44100, hop_size = 512, f0_min = 40, f0_max = 1600):
    ...
    def extract(self, audio, uv_interp = False, device = None, silence_front = 0): # audio: 1d numpy array
        ...
        # extract f0 using crepe        
            ...
            wav16k_torch = resample_kernel(torch.FloatTensor(audio).to(device)).unsqueeze(0)
